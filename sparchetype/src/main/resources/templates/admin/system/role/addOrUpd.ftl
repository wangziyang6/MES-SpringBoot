        ...
        <form class="layui-form layuimini-form">
            <div class="layui-row">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md6">
                    ...
                    <div class="layui-form-item">
                        <label for="js-radio" class="layui-form-label sp-required">状态
                        </label>
                        <div class="layui-input-inline">
                            <input type="radio" name="status" value="1" title="正常" <#if result.status == "0" || !(result??)>checked</#if>>
                            <input type="radio" name="status" value="0" title="已删除" <#if result.status == "1">checked</#if>>
                        </div>
                    </div>
                </div>
