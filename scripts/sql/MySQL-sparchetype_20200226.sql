...
CREATE TABLE `sp_sys_dict` (
  ...
  `status` char(2) NOT NULL COMMENT '状态：逻辑已删除值(默认为 1); 逻辑未删除值(默认为 0)',
...
CREATE TABLE `sp_sys_role` (
  ...
  `status` varchar(2) NOT NULL COMMENT '状态(0:删除;1:正常;2:禁用)',
  `created` datetime NOT NULL COMMENT '创建时间',
  `created_by` varchar(64) NOT NULL COMMENT '创建人',
  `last_upd` datetime NOT NULL COMMENT '最后更新时间',
...
-- ----------------------------
INSERT INTO `sp_sys_role` VALUES ('1185025876737396738', '超级管理员', 'admin', '超级管理员', '0', '2019-10-18 10:52:40', 'SongPeng', '2019-10-18 10:52:40', 'SongPeng');
INSERT INTO `sp_sys_role` VALUES ('1232532514523213826', '体验者', 'experience', '体验者', '0', '2020-02-26 13:07:05', 'admin', '2020-02-26 13:07:05', 'admin');
...
CREATE TABLE `sp_sys_user` (
  ...
  `descr` varchar(255) DEFAULT '""' COMMENT '描述',
  `status` varchar(1) NOT NULL COMMENT '状态(0:删除;1:正常;2:禁用)',
  `created` datetime NOT NULL COMMENT '创建时间',
  `created_by` varchar(64) NOT NULL COMMENT '创建人',
  `last_upd` datetime NOT NULL COMMENT '最后更新时间',
  `last_upd_by` varchar(64) NOT NULL COMMENT '最后更新人',
...
-- ----------------------------
INSERT INTO `sp_sys_user` VALUES ('1184009088826392578', '宋鹏', 'iamsongpeng', '123', '', '', '13776337795', '', '1', null, '', '', '', '', '', '', '', '', '', '0', '2019-10-15 15:32:19', 'SongPeng', '2019-10-15 15:51:29', 'SongPeng');
INSERT INTO `sp_sys_user` VALUES ('1184010472443396098', '猴子', 'monkey', '1', '123', '', '137763377', '', '0', null, '', '', '', '', '', '', '', '', '', '0', '2019-10-15 15:37:52', 'SongPeng', '2020-02-25 09:34:30', 'admin');
INSERT INTO `sp_sys_user` VALUES ('1184019107907227649', '超级管理员', 'admin', '9d7281eeaebded0b091340cfa658a7e8', '11', '', '13776337796', '44', '0', null, '55', '66', '77', '88', '99', '10', '11', '12', '13', '0', '2019-10-15 16:12:08', 'SongPeng', '2019-10-18 13:05:28', 'SongPeng');
